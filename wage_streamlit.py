...
df_ts_mean = df_ts_mean.rename(columns={'一人当たり賃金（万円）':'全国＿一人当たり賃金（万円）'})
...
df_mean_line = df_mean_line[['集計年','全国＿一人当たり賃金（万円）','一人当たり賃金（万円）']]
df_mean_line = df_mean_line.set_index('集計年')

 #折れ線グラフを表現する
st.line_chart(df_mean_line)

#年齢階級別の全国一人あたり平均賃金をバブルチャートで可視化
